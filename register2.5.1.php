...
<!------ Include the above in your HEAD tag ---------->
 ...
 <!-- process step bar -->
    ...
    <div class="container">
        ...
        <div id="London" class="w3-container w3-padding-64 w3-border bor1 city">
            <br><center>
    <?php while($row = $result->fetch_assoc()): ?>    
                ...
                <header class="clearfix">
                    ...
                    ?>
                        ...
                        <!-- <a onclick ="document.getElementById('<?="id".$rowA["run_id"]?>').style.display='block'"><span></span></a> -->
                        <a <a href="updateregister.php?id=<?=$rowA["run_id"]?>"><span></span></a>
                    </div>
                    <form name="test" method="post" action="add/delregister.php?id=<?=$row["run_id"]?>">
                ...
                <div class="col-sm-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 form-group" >
                                ...
                                <input type="id" name="essn" placeholder="กรุณากรอก เลขบัตรประชาชน หรือ passport" class="form-control" required minlength="7" maxlength="13" id = "pass1" style="margin-left:10px">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6 form-group">
                                ...
                                <input type="text" name="phone" placeholder="กรุณากรอกเบอร์โทรศัพท์ของคุณ" class="form-control" autofocus required id="phone" maxlength="10" onkeyup="validatephone(this);">
                            </div>
                            <div class="col-sm-6 form-group" >
                                <label for="address" style="margin-left:10px">ที่อยู่<font color="red"> *</font></label>
                                <input type="text" name="address" placeholder="กรุณากรอกที่อยู่ของคุณ" class="form-control" autofocus required id = "txt" onkeyup = "Validate(this)" style="margin-left:10px">
                            </div>
                        </div>	
                        ...
                        <div class="row">
                            <div class="col-sm-6 form-group">
                                ...
                                <input type="text" name="province" placeholder="กรุณากรอกจังหวัดของคุณ" class="form-control" autofocus required id = "txt" onkeyup = "Validate(this)">
                            </div>
                            <div class="col-sm-6 form-group" >
                                <label for="postcode" style="margin-left:10px">รหัสไปรษณีย์<font color="red"> *</font></label>
                                <input type="text" name="postcode" placeholder="กรุณากรอกรหัสไปรษณีย์ของคุณ" class="form-control" autofocus required id="postcode" maxlength="5" onkeyup="validatephone(this);" style="margin-left:10px">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6 form-group">
                                ...
                                <input type="text" name="emergency_contact_name" placeholder="กรุณากรอกชื่อผู้ติดต่อฉุกเฉินของคุณ" class="form-control" autofocus required id = "txt" onkeyup = "Validate(this)">
                            </div>
                            <div class="col-sm-6 form-group" >
                                <label for="Emergency number" style="margin-left:10px">เบอร์ติดต่อกรณีฉุกเฉิน<font color="red"> *</font></label>
                                <input type="text" name="emergency_contact_phone" placeholder="กรุณากรอกเบอร์ติดต่อฉุกเฉินของคุณ" class="form-control" autofocus required id="phone" maxlength="10" onkeyup="validatephone(this);" style="margin-left:10px">
                            </div>
                        </div>	
                        ...
                        <div class="row">
                            <div class="col-sm-6 form-group">
                                ...
                                <input type="text" name="disease" placeholder="กรุณากรอกโรคประจำตัวของคุณ" class="form-control" autofocus>
                            </div>
                            <div class="col-sm-6 form-group" >
                                <label for="allergic_drug" style="margin-left:10px">การแพ้ยา</label>
                                <input type="text" name="allergic_drug" placeholder="กรุณากรอกการแพ้ยาของคุณ" class="form-control" autofocus style="margin-left:10px">
                            </div>
                        </div>	
                        ...
                        <div class="row">
                            <div class="col-sm-6 form-group">
                                ...
                                <input type="text" name="medicine" placeholder="กรุณากรอกยาที่คุณใช้เป็นประจำ" class="form-control" autofocus>
                            </div>
                            <div class="col-sm-6 form-group" >
...
<div id="'id'.<?=$rowA["run_id"]?>" class="w3-modal">
        <div class="w3-modal-content">
            <div class="w3-container">
                <span onclick="document.getElementById('<?="id".$rowA["run_id"]?>').style.display='none'" class="w3-button w3-display-topright">&times;</span>
                <form class="form-horizontal" role="form" action="add/addregister.php" method="POST"  enctype="multipart/form-data">
