...
$sqlA = "SELECT * FROM runners  WHERE run_id = ".$_GET['id'];
...
<script src="javascript/validateregister.js"></script>
   ...
   <center><h4 style="color:green">แก้ไขข้อมูลการสมัคร</h4></center>

    <div class="container" style="background-color: white;margin-bottom:30px;">
        <div class="col-lg-12">
            <div class="row">
                <form class="form-horizontal" role="form" action="add/updateregister.php?id=<?=$_GET['id']?>" method="POST"  enctype="multipart/form-data">    
                    <div class="col-sm-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 form-group" >
                                ...
                                <input type="text" name="last_name" placeholder="นามสกุล" class="form-control" autofocus required id = "txt" onkeyup = "Validate(this)" style="margin-left:10px" value="<?=$rowA["last_name"]?>">
                            </div>
                        </div>	
                        ...
                        <div class="row">
                            ...
                            <select name="year" class="form-control" required onchange="this.setCustomValidity(validity.valueMissing ?  : '');" id="field_terms">
                                        <option value="<?=$date[0]?>"><?=$d+543?></option> 
                        ...
                        <div class="row">
                            <div class="col-sm-6 form-group">
                                ...
                                <input type="email" name="email" placeholder="example@gmail.com" class="form-control" required id = "email"  onchange="email_validate(this.value);" value="<?=$rowA["email"]?>" />
                            </div>
                            <div class="col-sm-6 form-group" >
                                <label for="essn" style="margin-left:10px">เลขบัตรประชาชน/passport<font color="red"> *</font></label>
                                <input type="id" name="essn" placeholder="กรุณากรอก เลขบัตรประชาชน หรือ passport" class="form-control" required minlength="7" maxlength="13" id = "pass1" style="margin-left:10px" value="<?=$rowA["essn"]?>">
                            </div>
                        </div>
                            ...
                            <div class="col-sm-6 form-group" >
                                ...
                                <div>
                                    <select name="nationality" class="form-control" required onchange="this.setCustomValidity(validity.valueMissing ?  : '');" id="field_terms">
                                        <option value="<?=$rowA['nationality']?>"><?=$rowA['nationality']?></option>
                        ...
                        <div class="row">
                            <div class="col-sm-6 form-group">
                                ...
                                <input type="text" name="phone" value="<?=$rowA['phone']?>"  placeholder="กรุณากรอกเบอร์โทรศัพท์ของคุณ" class="form-control" autofocus required id="phone" maxlength="10" onkeyup="validatephone(this);">
                            </div>
                            <div class="col-sm-6 form-group" >
                                <label for="address" style="margin-left:10px">ที่อยู่<font color="red"> *</font></label>
                                <input type="text" name="address" value="<?=$rowA['address']?>"  placeholder="กรุณากรอกที่อยู่ของคุณ" class="form-control" autofocus required id = "txt" onkeyup = "Validate(this)" style="margin-left:10px">
                            </div>
                        </div>	
                        ...
                        <div class="row">
                            <div class="col-sm-6 form-group">
                                ...
                                <input type="text" name="province"  value="<?=$rowA['province']?>" placeholder="กรุณากรอกจังหวัดของคุณ" class="form-control" autofocus required id = "txt" onkeyup = "Validate(this)">
                            </div>
                            <div class="col-sm-6 form-group" >
                                <label for="postcode" style="margin-left:10px">รหัสไปรษณีย์<font color="red"> *</font></label>
                                <input type="text" name="postcode"   value="<?=$rowA['postcode']?>" placeholder="กรุณากรอกรหัสไปรษณีย์ของคุณ" class="form-control" autofocus required id="postcode" maxlength="5" onkeyup="validatephone(this);" style="margin-left:10px">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6 form-group">
                                ...
                                <input type="text" name="emergency_contact_name" value="<?=$rowA['emergency_contact_name']?>" placeholder="กรุณากรอกชื่อผู้ติดต่อฉุกเฉินของคุณ" class="form-control" autofocus required id = "txt" onkeyup = "Validate(this)">
                            </div>
                            <div class="col-sm-6 form-group" >
                                <label for="Emergency number" style="margin-left:10px">เบอร์ติดต่อกรณีฉุกเฉิน<font color="red"> *</font></label>
                                <input type="text" name="emergency_contact_phone" value="<?=$rowA['emergency_contact_phone']?>" placeholder="กรุณากรอกเบอร์ติดต่อฉุกเฉินของคุณ" class="form-control" autofocus required id="phone" maxlength="10" onkeyup="validatephone(this);" style="margin-left:10px">
                            </div>
                        </div>	
                        ...
                        <div class="row">
                            <div class="col-sm-6 form-group">
                                ...
                                <input type="text" name="disease" value="<?=$rowA['disease']?>" placeholder="กรุณากรอกโรคประจำตัวของคุณ" class="form-control" autofocus>
                            </div>
                            <div class="col-sm-6 form-group" >
                                <label for="allergic_drug" style="margin-left:10px">การแพ้ยา</label>
                                <input type="text" name="allergic_drug" value="<?=$rowA['allergic_drug']?>" placeholder="กรุณากรอกการแพ้ยาของคุณ" class="form-control" autofocus style="margin-left:10px">
                            </div>
                        </div>	
                        ...
                        <div class="row">
                            <div class="col-sm-6 form-group">
                                ...
                                <input type="text" name="medicine"  value="<?=$rowA['medicine']?>" placeholder="กรุณากรอกยาที่คุณใช้เป็นประจำ" class="form-control" autofocus>
                            </div>
                            <div class="col-sm-6 form-group" >
                        ...
                        $sqlB = "SELECT * FROM runners_bills WHERE bill_id = $bill_id AND run_id = " .$_GET['id'];
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 form-group">
                                <div class="col-sm-12">
                                    ...
                                    <div class="col-sm-4">
                                        <label class="radio-inline">
                                            <input type="radio"  name="flag" <?php echo (!empty($rowB['flag_full']))? "checked":"" ;?>  id="fullmarathonRadio" value="1" required onchange="this.setCustomValidity(validity.valueMissing ?  : '');">Fullmarathon
                                        </label>
                                    </div>
                                    <?php 
                                        }
                                    ...
                                    <div class="col-sm-4">
                                        <label class="radio-inline">
                                            <input type="radio" name="flag" <?php echo (!empty($rowB['flag_half']))? "checked":"" ;?> id="halfmarathonRadio" value="2">Halfmarathon
                                        </label>
                                    </div>
                                    <?php 
                                        }
                                    ...
                                    <div class="col-sm-4">
                                        <label class="radio-inline">
                                            <input type="radio" name="flag" <?php echo (!empty($rowB['flag_mini']))? "checked":"" ;?> id="minimarathonRadio" value="3">Minimarathon
                                        </label>
                                    </div>
                                    <?php 
                                        }
                                    ...
                                    <div class="col-sm-4">
                                        <label class="radio-inline">
                                            <input type="radio" name="flag" <?php echo (!empty($rowB['flag_fun']))? "checked":"" ;?> id="funrunRadio" value="4">Funrun
                                        </label>
                                    </div>
                                    <?php } ?>
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <label class="radio-inline">
                                            <input type="radio" id="longRadio" <?php echo ($rowB['type_shirt'] == "1")? "checked":"" ;?> name="type_shirt" value="1" required onchange="this.setCustomValidity(validity.valueMissing ?  : '');">แบบที่ 1
                                        </label> 
                                    ...
                                    <div class="col-sm-6">  
                                        <label class="radio-inline">
                                            <input type="radio"  id="shortRadio" <?php echo ($rowB['type_shirt'] == "2")? "checked":"" ;?> name="type_shirt" value="2">แบบที่ 2
                                        </label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 form-group">
                                <div class="col-sm-12">
                                    <div class="col-sm-4">
                                        <label class="radio-inline">
                                            <input type="radio" id="SSRadio" name="size" value="1" <?php echo ($rowB['size'] == "1")? "checked":"" ;?> required onchange="this.setCustomValidity(validity.valueMissing ?  : '');">SS
                                        </label>
                                    </div>
                                    <div class="col-sm-4">  
                                        <label class="radio-inline">
                                            <input type="radio"  id="SRadio" name="size" value="2" <?php echo ($rowB['size'] == "2")? "checked":"" ;?>>S
                                        </label>
                                    </div>
                                    <div class="col-sm-4">  
                                        <label class="radio-inline">
                                            <input type="radio"  id="MRadio" name="size" value="3" <?php echo ($rowB['size'] == "3")? "checked":"" ;?>>M
                                        </label>
                                    </div>
                                    <div class="col-sm-4">  
                                        <label class="radio-inline">
                                            <input type="radio"  id="LRadio" name="size" value="4" <?php echo ($rowB['size'] == "4")? "checked":"" ;?>>L
                                        </label>
                                    </div>
                                    <div class="col-sm-4">  
                                        <label class="radio-inline">
                                            <input type="radio"  id="XLRadio" name="size" value="5" <?php echo ($rowB['size'] == "5")? "checked":"" ;?>>XL
                                        </label>
                                    </div>
                                    <div class="col-sm-4">  
                                        <label class="radio-inline">
                                            <input type="radio"  id="XXLRadio" name="size" value="6" <?php echo ($rowB['size'] == "6")? "checked":"" ;?>>XXL
                                        </label>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 form-group">
                                <div class="col-sm-12">
                                    <label class="radio-inline">
                                        <input type="radio" id="longRadio" name="getting" value="0" <?php echo ($rowB['getting'] == "0")? "checked":"" ;?> required onchange="this.setCustomValidity(validity.valueMissing ?  : '');">รับด้วยตัวเองที่สถานที่จัดงาน
                                    </label>
                                </div>
                                <div class="col-sm-12">  
                                    <label class="radio-inline">
                                        <input type="radio"  id="shortRadio"  name="getting" value="1" <?php echo ($rowB['getting'] == "1")? "checked":"" ;?>>ส่งไปรษณีย์ (ค่าส่ง 100 บาท)
                                    </label>
                                </div>
                            </div>
                        </div>					
                    ...
                    <div class="form-group" style="margin-bottom:30px;">
                            <div class="col-sm-6 col-sm-offset-3">
                                <br><br><button type="submit" class="btn">บันทึก</button></a>
                            </div>
                    </div>
                </form> 
            </div>
